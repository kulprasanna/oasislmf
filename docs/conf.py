...
# sphinx-quickstart on Fri Jun 30 14:44:18 2017.
#
...
sys.path.insert(0, os.path.abspath(os.path.join(repo_base, 'src', 'flamingo_api_server')))
#print sys.path
...
texinfo_documents = [
    (master_doc, 'Flamingo', u'Flamingo Documentation',
     author, 'Flamingo', 'One line description of project.',
     'Miscellaneous'),
]
